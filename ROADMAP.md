...
M4 depends on HOST-248. Snapshot revision 12137 records HOST-246 and
HOST-247 complete and HOST-248 resumed for the authorized receipt correction.
...
retains both failed gates and evidence. The two-path correction passes the
actual populated-database operation; matching deployment and full acceptance
are pending. Any new full-gate failure stops the loop. Later cards remain
unclaimed.
