...
M4 depends on HOST-248. Snapshot revision 12119 records HOST-246 and HOST-247
complete and HOST-248 blocked after the first full deployed gate failed at
demo-origin readiness. The original route was restored, receipt checksums
verified, and the repair/retry loop stopped. [The M3.5 handoff](docs/M3.5-HANDOFF.md)
records the result and evidence gaps. Later cards remain unclaimed.
