...
help:
	...
	@echo 'make e2e        Run M2 onboarding E2E and retain evidence'
...
e2e:
	node e2e/run.mjs --milestone M2 --task HOST-243 --scenario-module e2e/scenarios/onboarding.mjs --run-timeout 900000 $(E2E_ARGS)

e2e-scaffold:
	node e2e/run.mjs $(E2E_ARGS)

e2e-gate:
	node e2e/run.mjs --require-clean --milestone M2 --task HOST-243 --scenario-module e2e/scenarios/onboarding.mjs --run-timeout 900000 $(E2E_ARGS)
