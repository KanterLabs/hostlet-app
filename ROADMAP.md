...
M4 depends on HOST-248. Snapshot revision 12173 records HOST-246 and
HOST-247 complete and HOST-248 resumed after the checkpoint 2 stop. The first
...
under the plan's same-failure rule. Shane then instructed "use sol and fix",
resuming scoped correction and recovery with Sol medium workers.
